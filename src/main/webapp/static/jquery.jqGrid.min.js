    ...
    d.jgrid.extend({
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                "true" === j[i] || !0 === j[i] ? (n += (void 0 !== j[f] && "" !== j[f] ? j[f] : a.p.treeIcons.leaf) + " blue icon-user treeclick", j[i] = !0, m = "leaf") : (j[i] = !1, m = ""),
                j[e] = ("true" === j[e] || !0 === j[e] ? !0 : !1) && (j[l] || void 0 === j[l]),
                n = !1 === j[e] ? n + (!0 === j[i] ? "'": a.p.treeIcons.plus + " icon-plus treeclick'") : n + (!0 === j[i] ? "'": a.p.treeIcons.minus + " icon-minus treeclick'"),
                n += "></div></div>",
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!b[c]) {
                        ...
                        k = this.p._index[f];
                        d(this).jqGrid("isNodeLoaded", this.p.data[k]) ? (b[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " icon-plus").addClass(this.p.treeIcons.minus + " icon-minus")) : this.grid.hDiv.loading || (b[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " icon-plus").addClass(this.p.treeIcons.minus + " icon-minus"), this.p.treeANode = l.rowIndex, this.p.datatype = this.p.treedatatype, "nested" === this.p.treeGridModel ? d(this).jqGrid("setGridParam", {
                            postData: {
                                nodeid: f,
                                n_left: b[i],
                                n_right: b[g],
        ...
        collapseNode: function(b) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var c = this.p.treeReader.expanded_field;
                    b[c] && (b[c] = !1, c = d.jgrid.getAccessor(b, this.p.localReader.id), c = d("#" + this.p.idPrefix + d.jgrid.jqID(c), this.grid.bDiv)[0], d("div.treeclick", c).removeClass(this.p.treeIcons.minus + " icon-minus").addClass(this.p.treeIcons.plus + " icon-plus"))
                }
            })
        },
        ...
        addChildNode: function(b, c, a, h) {
            ...
            if (a) {
                ...
                q[i] = !0,
                d(e.rows[v]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.blue icon-user").removeClass(e.p.treeIcons.leaf + " blue icon-user").addClass(e.p.treeIcons.minus + " icon-minus"),
                e.p.data[r][g] = !1,
                q[n] = !0;
                r = p + 1;
                void 0 === a[i] && (a[i] = !1);
