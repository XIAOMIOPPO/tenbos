package com.yidu.tencloud.bean.taketosend.assignmentDetailed;
 ...
 * @since 2017/12/25
 */
public class AssignmentDetailed {
    ...
    private double delayRate;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			AssignmentDetailed other = (AssignmentDetailed) obj;
		...
		public String toString() {
			return "AssignmentDetailed [workSheetNo=" + workSheetNo + ", signStatus=" + signStatus + ", addressesName="
		...
		public AssignmentDetailed(String workSheetNo, String signStatus, String addressesName, String empName,
